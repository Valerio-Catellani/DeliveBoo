...
<section id="dashboard" data-user-id="{{ Auth::user()->id }}">
    ...
    @if ($restaurant)
        <div id="restaurant-dashboard" class=" mx-auto p-5 d-flex flex-column gap-5">
            <div class="container">
                <h2 class="mb-5 display-2">Benvenuto <strong>{{ Auth::user()->name }} {{ Auth::user()->lastname }}</strong>
                </h2>
                <div class="row">
                    <div class="col-12 col-xxl-6">
                        <div class="card card-custom bg-white border-white border-0 h-100">
                            ...
                            <div class="card-body" style="overflow-y: auto">
                                ...
                                <hr>
                                <p>Resoconto Amministrativo per il mese: <span id='current_month' class="fw-bold"></span>
                                </p>
